        ...
        assertThat(
                ...
                is(
                        new StringBuilder()
                                ...
                                .append(System.lineSeparator()).append("Заявка: ID: " + item.getId() + "   Имя: name                 Описание: name                ")
                                .append(System.lineSeparator()).append("Заявка: ID: " + item1.getId() + "   Имя: name1                Описание: name1               ")
                                .append(System.lineSeparator()).append("Заявка: ID: " + item2.getId() + "   Имя: name2                Описание: name2               ")
                                .append(System.lineSeparator()).append("------------ Вывод всех заявок --------------")
